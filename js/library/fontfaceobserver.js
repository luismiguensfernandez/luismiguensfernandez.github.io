        ...
        return new Promise(function (e, i) {
            if (
                ...
                var p = new Promise(function (e, t) {
                        !(function n() {
                            new Date().getTime() - f >= h
                                ...
                                : document.fonts.load(u(s, '"' + s.family + '"'), r).then(function (t) {
                ...
                !(function (e) {
                    ...
                    function d() {
                        var t;
                        (t = (-1 != w && -1 != v) || (-1 != w && -1 != y) || (-1 != v && -1 != y)) &&
                            ((t = w != v && w != y && v != y) ||
                                (null === a && ((t = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent)), (a = !!t && (536 > parseInt(t[1], 10) || (536 === parseInt(t[1], 10) && 11 >= parseInt(t[2], 10))))),
                                (t = a && ((w == x && v == x && y == x) || (w == b && v == b && y == b) || (w == g && v == g && y == g)))),
                            (t = !t)),
                            t && (E.parentNode && E.parentNode.removeChild(E), clearTimeout(c), e(s));
                    }
                    var l = new t(r),
                        p = new t(r),
                        m = new t(r),
